...
<template>
    <aside class="col-span-1 sm:col-span-2 border border-gray-200">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#1ca0f2" class="w-12 h-12 mx-auto my-12">
            <path
        ...
        <nav class="space-y-3">
            <div class="flex items-center px-4 space-x-2 cursor-pozz">
            ...
            <div @click="appSignOut" class="flex px-4 items-center space-x-2 cursor-pozz">
